...
<body>
	...
	<h1><b>Pediatricians visited<hr><i>These are the pediatricians that baby <?php echo ''.$this->session->userdata('username').''; ?> has visited</i></h1></b>
