...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	body{
		background-image: url(<?php echo base_url() ?>assets/images/landingpic3.jpg);
...
<body>
	<header><b><p style="font-size: 25px; color: white;margin-left: 80px;">Baby Immunization<img src="<?php echo base_url() ?>assets/images/logo.png" alt="Logo" style="width:100px; border-radius: 0; margin-left: 10px;"></p></b></header>
<div class="me">
		<ul>
	...
	<div id="login1" class="modal fade" >
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form method="POST" id="insert_form" enctype="multipart/form-data" action="Home">
	...
	<div id="signup1" class="modal fade" >
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
				<form method="POST" id="insert_form" enctype="multipart/form-data" action="Register">
