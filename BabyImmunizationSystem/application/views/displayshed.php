...
<body>
	...
	<h1><b>Scheduled vaccines<hr><i>These are the vaccines that have been scheduled for baby <?php echo ''.$this->session->userdata('username').''; ?> </i></h1></b>
...
if($fetch_data4->num_rows()>0){
foreach($fetch_data4->result() as $row){
