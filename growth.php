...
Baby_Name :<input type="text" name="baby_name"><br><br>
Baby_Weight :<input type="text" name="baby_weight"><br><br>
Baby_Height :<input type="text" name="baby_height"><br><br>
