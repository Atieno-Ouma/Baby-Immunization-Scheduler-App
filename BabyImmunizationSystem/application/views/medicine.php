...
<body>
	...
	<h1><b>Medicine records<hr><i>These are the medicine taken by baby <?php echo ''.$this->session->userdata('username').''; ?> </i></h1></b>
...
if($fetch_data5->num_rows()>0){
foreach($fetch_data5->result() as $row){
